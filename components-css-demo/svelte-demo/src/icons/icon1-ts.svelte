...
let {halign, valign, focus, width, height, ...props}: Props = $props();

let states = $derived(({ 'halign': namedStateValue(halign, 'left'), 'valign': namedStateValue(valign, 'top'), 'focus': focus }));
