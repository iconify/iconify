<template>
	<section>
		...
		<div>
			Red color:
			<iconify-icon icon="demo" inline :style="{ color: 'red', verticalAlign: 0 }" />
			<iconify-icon icon="demo" inline style="color: red; vertical-align: 0" />
		...
		<div>
			...
			<iconify-icon icon="demo" inline :style="{ fontSize: '40px', verticalAlign: 0 }" />
		...
		<div>
			...
			<iconify-icon icon="demo" :style="{ color: 'red', fontSize: '40px' }" />
