...
or
```html
<script src="https://cdn.jsdelivr.net/npm/@iconify/iconify@1.0.5/dist/iconify.min.js"></script>
```
...
```html
<script src="https://code.iconify.design/1/1.0.5/plugin-fa.min.js"></script>
```
