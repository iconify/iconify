...
or
```
<script src="https://cdn.jsdelivr.net/npm/@iconify/iconify@1.0.2/dist/iconify.min.js"></script>
```
...
How to use plugins? Include plugin script:
    ...
    <script src="https://code.iconify.design/1/1.0.2/plugin-fa.min.js"></script>
