...
```html
<script src="https://code.iconify.design/iconify-icon/2.2.0-dev.1/iconify-icon.min.js"></script>
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/iconify-icon@2.2.0-dev.1/dist/iconify-icon.min.js"></script>
```
