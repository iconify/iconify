...
/**
 * Temporary replacement for automatically generated interface to allow including Iconify in TypeScript projects.
 *
 * This will be fixed in Iconify 2.0 that is currently in development, re-written in TypeScript.
 */
interface IconifyGlobal {
  preloadImages: (names: string[]) => void;
  pauseObserving: () => void;
  resumeObserving: () => void;
  getConfig: (name: string) => unknown;
  setConfig: (name: string, value: unknown) => void;
  setCustomAPI: (prefix: string, uri: string) => void;
  addCollection: (data: IconifyJSON) => void;
  ...
  getSVG: (name: string, attributes: unknown) => string;
  addFinder: (name: string, finder: () => void) => void;
  addTag: (name: string, inline: boolean, resolver: () => void) => void;
