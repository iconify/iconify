...
```html
<script src="https://code.iconify.design/3/3.0.0-beta.3/iconify.min.js"></script>
```

or

```html
<script src="https://cdn.jsdelivr.net/npm/@iconify/iconify@3.0.0-beta.3/dist/iconify.min.js"></script>
```
