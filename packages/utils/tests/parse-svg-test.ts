import { parseSVGContent, getSVGViewBox } from '../lib/svg/parse';
import { readFileSync } from 'node:fs';

const fixturesDir = './tests/fixtures';

describe('Testing parseSVGContent and getSVGViewBox', () => {
	...
	test('SVG with XML heading', () => {
		...
		expect(parsed?.body).toEqual('<circle cx="60" cy="60" r="50"/>');
	});
});
