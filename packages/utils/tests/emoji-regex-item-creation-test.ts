...
describe('Creating chunks of regex', () => {
	it('UTF-16 numbers', () => {
		...
		expect(
			createUTF16EmojiRegexItem([
				0x2760, 0x2762, 0x2761, 0x2765, 0x2763, 0xfe0f, 0xfe0f, 0xfe0e, 0x2000,
				0x2001, 0x2100, 0x2102, 0x2101,
			])
		).toEqual({
			type: 'utf16',
			regex:
				'[\\u2000\\u2001\\u2100-\\u2102\\u2760-\\u2763\\u2765\\uFE0E\\uFE0F]',
			numbers: [
				0x2000, 0x2001, 0x2100, 0x2101, 0x2102, 0x2760, 0x2761, 0x2762, 0x2763,
				0x2765, 0xfe0e, 0xfe0f, 0xfe0f,
			],
			length: 1,
			group: true,
		});
	...
	it('Mix', () => {
		const num1 = createUTF16EmojiRegexItem([0x1234, 0x1235, 0x1236, 0x1237]);
